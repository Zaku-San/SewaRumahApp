...
let lightMode = "white";
let orange = "#F58634";
let darkNavbar = "rgba(44, 44, 44, 0.9)";
let lightNavbar = "rgba(255, 255, 255, 0.9)";
const navbar = document.querySelector(".container .navbar .navbar-item");
let isClicked = false;
...
function changeMode(event) {
  ...
  let houseTitle = document.querySelectorAll(
    ".container .sale-house .houses-container .description h2"
  );
  //   view more
  ...
  if (isClicked) {
    ...
    darkIcon.innerHTML =
      '<i class="fa-regular fa-moon fa-xl" style="color: #1b2021" id="myButton"></i>';
    // house title
    ...
    darkIcon.innerHTML =
      '<i class="fa-solid fa-moon fa-xl" style="color: #f58634;" id="myButton"></i>';
